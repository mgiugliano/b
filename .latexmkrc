...
# Use zathura as the default PDF viewer on Linux.
$pdf_previewer = "zathura %O %S";

# All tex files are in the folder ./tex
$ENV{"TEXINPUTS"} = ".:./tex//:" . $ENV{"TEXINPUTS"};

# All images are in the folder ./images
$ENV{"TEXINPUTS"} = ".:./figs//:" . $ENV{"TEXINPUTS"};

# All styles are in the folder ./styles
$ENV{"TEXINPUTS"} = ".:./styles//:" . $ENV{"TEXINPUTS"};

# All bib files are in the folder ./bib
...
# `0` is off.
# Testing in VSCode w/ LaTeX Worksho only worked for the compressed version.
